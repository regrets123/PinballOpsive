...
Shader "DawnShaderHDRP/ClothingShaderHDRP"
{
	Properties
	{
		...
		[Toggle(_USEALPHACUTOUT_ON)] _UseAlphaCutOut("Use Alpha Cut Out", Float) = 0
	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				surfaceDescription.BaseColor = lerpResult87.rgb;
				...
				surfaceDescription.Emission = ( _Emissivepowerboost * ( ( tex2DNode231.r * tex2DNode228 * _EmissiveColor01 * _EmissiveBoots1 ) + ( tex2DNode231.g * tex2DNode228 * _EmissiveColor02 * _Float0 ) + ( tex2DNode231.b * tex2DNode228 * _EmissiveColor03 * _EmissiveBoots3 ) + ( tex2DNode231.a * tex2DNode228 * _EmissiveColor04 * _Float1 ) ) ).rgb;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				BuiltinData builtinData;
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 uv_BC = packedInput.ase_texcoord2.xy * _BC_ST.xy + _BC_ST.zw;
				float4 tex2DNode1 = tex2D( _BC, uv_BC );
				...
				float4 lerpResult31 = lerp( float4( 0,0,0,0 ) , _BlendColor04 , tex2DNode2.a);
				float4 lerpResult132 = lerp( tex2DNode1 , ( lerpResult28 + lerpResult29 + lerpResult30 + lerpResult31 ) , ( ( _BlendColorPower01 * tex2DNode2.r ) + ( _BlendColorPower02 * tex2DNode2.g ) + ( _BlendColorPower03 * tex2DNode2.b ) + ( _BlendColorPower04 * tex2DNode2.a ) ));
				float2 uv_Texture01 = packedInput.ase_texcoord2.xy * _Texture01_ST.xy + _Texture01_ST.zw;
				float4 lerpResult55 = lerp( float4( 0,0,0,0 ) , tex2D( _Texture01, uv_Texture01 ) , tex2DNode2.r);
				#ifdef _BLENDTEXTURE01_ON
				float4 staticSwitch60 = lerpResult55;
				#else
				float4 staticSwitch60 = tex2DNode1;
				#endif
				float2 uv_Texture02 = packedInput.ase_texcoord2.xy * _Texture02_ST.xy + _Texture02_ST.zw;
				float4 lerpResult56 = lerp( float4( 0,0,0,0 ) , tex2D( _Texture02, uv_Texture02 ) , tex2DNode2.g);
				#ifdef _BLENDTEXTURE02_ON
				float4 staticSwitch61 = lerpResult56;
				#else
				float4 staticSwitch61 = tex2DNode1;
				#endif
				float2 uv_Texture03 = packedInput.ase_texcoord2.xy * _Texture03_ST.xy + _Texture03_ST.zw;
				float4 lerpResult57 = lerp( float4( 0,0,0,0 ) , tex2D( _Texture03, uv_Texture03 ) , tex2DNode2.b);
				#ifdef _BLENDTEXTURE03_ON
				float4 staticSwitch62 = lerpResult57;
				#else
				float4 staticSwitch62 = tex2DNode1;
				#endif
				float2 uv_Texture04 = packedInput.ase_texcoord2.xy * _Texture04_ST.xy + _Texture04_ST.zw;
				float4 lerpResult58 = lerp( float4( 0,0,0,0 ) , tex2D( _Texture04, uv_Texture04 ) , tex2DNode2.a);
				#ifdef _BLENDTEXTURE04_ON
				float4 staticSwitch63 = lerpResult58;
				#else
				...
				float4 tex2DNode231 = tex2D( _EmissiveMask, uv_EmissiveMask );
				float2 temp_cast_2 = (_EmissivePannerTilling).xx;
				float2 texCoord223 = packedInput.ase_texcoord2.xy * temp_cast_2 + float2( 0,0 );
				float2 panner224 = ( ( _TimeParameters.x ) * _PannerProperty + texCoord223);
				float4 tex2DNode228 = tex2D( _EmissivePannerMap, panner224 );
...
Node;AmplifyShaderEditor.StaticSwitch;61;-2210.348,-219.3009;Float;False;Property;_BlendTexture02;Blend Texture 02;30;0;Create;True;0;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Create;False;True;All;9;1;COLOR;0,0,0,0;False;0;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;4;COLOR;0,0,0,0;False;5;COLOR;0,0,0,0;False;6;COLOR;0,0,0,0;False;7;COLOR;0,0,0,0;False;8;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.StaticSwitch;72;-834.3411,-172.6555;Float;False;Property;_BlendTextureMode;Blend Texture Mode;28;0;Create;True;0;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Create;False;True;All;9;1;COLOR;0,0,0,0;False;0;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;4;COLOR;0,0,0,0;False;5;COLOR;0,0,0,0;False;6;COLOR;0,0,0,0;False;7;COLOR;0,0,0,0;False;8;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.StaticSwitch;218;831.787,-1002.996;Inherit;False;Property;_UseAlphaCutOut;Use Alpha Cut Out;0;0;Create;True;0;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Create;True;True;All;9;1;COLOR;0,0,0,0;False;0;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;4;COLOR;0,0,0,0;False;5;COLOR;0,0,0,0;False;6;COLOR;0,0,0,0;False;7;COLOR;0,0,0,0;False;8;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.StaticSwitch;62;-2210.348,-111.9511;Float;False;Property;_BlendTexture03;Blend Texture 03;31;0;Create;True;0;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Create;False;True;All;9;1;COLOR;0,0,0,0;False;0;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;4;COLOR;0,0,0,0;False;5;COLOR;0,0,0,0;False;6;COLOR;0,0,0,0;False;7;COLOR;0,0,0,0;False;8;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.StaticSwitch;63;-2211.201,-1.129412;Float;False;Property;_BlendTexture04;Blend Texture 04;32;0;Create;True;0;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Create;False;True;All;9;1;COLOR;0,0,0,0;False;0;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;4;COLOR;0,0,0,0;False;5;COLOR;0,0,0,0;False;6;COLOR;0,0,0,0;False;7;COLOR;0,0,0,0;False;8;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.StaticSwitch;60;-2213.897,-327.3228;Float;False;Property;_BlendTexture01;Blend Texture 01;29;0;Create;True;0;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Create;False;True;All;9;1;COLOR;0,0,0,0;False;0;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;4;COLOR;0,0,0,0;False;5;COLOR;0,0,0,0;False;6;COLOR;0,0,0,0;False;7;COLOR;0,0,0,0;False;8;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.ColorNode;232;-3312.364,-3083.275;Float;False;Property;_EmissiveColor03;Emissive Color 03;43;0;Create;True;0;0;0;False;0;False;0,0,0,0;0.4009434,0.8080564,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;230;-2908.725,-2990.456;Float;False;Property;_EmissiveBoots1;Emissive Boots 1;40;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;231;-2912.769,-3609.988;Inherit;True;Property;_EmissiveMask;Emissive Mask;37;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;228;-2773.707,-2495.456;Inherit;True;Property;_EmissivePannerMap;Emissive Panner Map;47;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;221;-3692.704,-2630.711;Inherit;False;Property;_EmissivePannerTilling;Emissive Panner Tilling;48;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector2Node;222;-3333.707,-2527.456;Float;False;Property;_PannerProperty;Panner Property;49;0;Create;True;0;0;0;False;0;False;0,0;0.1,0.1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.RangedFloatNode;233;-2910.871,-2905.79;Float;False;Property;_Float0;Float 0;42;0;Create;True;0;0;0;False;0;False;0;2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;234;-2911.944,-2751.472;Float;False;Property;_Float1;Float 1;46;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;240;-1408.035,-3003.794;Inherit;False;Property;_Emissivepowerboost;Emissive power boost;38;0;Create;True;0;0;0;False;0;False;100;100;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;227;-3314.189,-3285.786;Float;False;Property;_EmissiveColor02;Emissive Color 02;41;0;Create;True;0;0;0;False;0;False;0,0,0,0;0,0.6797385,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;225;-3312.772,-3476.736;Float;False;Property;_EmissiveColor01;Emissive Color 01;39;0;Create;True;0;0;0;False;0;False;0,0,0,0;0.4009434,0.8080564,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;229;-3309.588,-2885.105;Float;False;Property;_EmissiveColor04;Emissive Color 04;45;0;Create;True;0;0;0;False;0;False;0,0,0,0;0,0.6797385,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;226;-2911.139,-2826.751;Float;False;Property;_EmissiveBoots3;Emissive Boots 3;44;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
WireConnection;244;1;75;0
WireConnection;244;4;128;0
WireConnection;244;6;241;0
WireConnection;244;7;88;0
WireConnection;244;8;74;0
WireConnection;244;9;218;0
WireConnection;244;10;217;0
ASEEND*/
//CHKSM=A8A16C9BB6CBBE03C6E07E5E67025C737D3C2CAC