	...
	SubShader
	{
		...
		Pass
		{
				...
				)
			{
				...
				float3 temp_cast_2 = (( _SpecularTint * tex2DNode2.a )).xxx;
				
				surfaceDescription.BaseColor = ( _Brighness * ( staticSwitch142 * tex2D( _NoiseTexture, ( packedInput.ase_texcoord7.xy * _NoiseTilling ) ).r ) ).rgb;
				surfaceDescription.Normal = normalizeResult65.rgb;
				surfaceDescription.BentNormal = float3( 0, 0, 1 );
				surfaceDescription.Smoothness = lerpResult73;
				surfaceDescription.Occlusion = 1;

				surfaceDescription.Transmittance = float3(0.3,0.19,0.09);
				...
				surfaceDescription.SpecularTint = temp_cast_2;
		...
		Pass
		{
			...
			float4 Frag( VertexOutput packedInput  ) : SV_Target
			{
				...
				surfaceDescription.BaseColor = ( _Brighness * ( staticSwitch142 * tex2D( _NoiseTexture, ( packedInput.ase_texcoord.xy * _NoiseTilling ) ).r ) ).rgb;
				surfaceDescription.Normal = normalizeResult65.rgb;
				surfaceDescription.BentNormal = float3( 0, 0, 1 );
				surfaceDescription.Smoothness = lerpResult73;
				surfaceDescription.Occlusion = 1;
...
WireConnection;144;3;73;0
WireConnection;144;8;2;4
WireConnection;144;9;105;0
WireConnection;144;16;72;0
WireConnection;73;1;71;0
WireConnection;73;2;2;4
WireConnection;72;0;70;0
WireConnection;72;1;2;4
ASEEND*/
//CHKSM=CD1CBAEBE9F04FCE978841B82C33C2C4337A9D52